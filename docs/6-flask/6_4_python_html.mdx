...
import CodeTable from '@site/src/components/CodeTable';
...
export const appPy = [
  ...
  'def rute_forside():',
  '    navn = "Lisa"',
  '    return render_template("forside.html", navn=navn)',
  '',
  'app.run(debug=True)',
].join('\n');

export const forsideHtml = String.raw`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
<CodeTable
  header={['app.py', 'forside.html']}
  body={[
    [
      { language: 'python', code: appPy },
      { language: 'html', code: forsideHtml },
    ],
  ]}
/>
